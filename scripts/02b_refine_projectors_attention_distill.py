...
def _distill_kwargs(cfg) -> dict:
    ...
    return {
        ...
        "lambda_topk": d.lambda_topk,
        "lambda_kl": d.lambda_kl,
        "lambda_logit_topm": d.lambda_logit_topm,
        "topk_k": d.topk_k,
        "hard_neg_m": d.hard_neg_m,
        "kl_top_m": d.kl_top_m,
        "topk_margin": d.topk_margin,
        "topk_metric_ks": tuple(d.topk_metric_ks),
